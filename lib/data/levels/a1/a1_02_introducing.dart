...
const A1Lesson a1Lesson02 = A1Lesson(
  id: 'a1_02',
  ...
  sentences: [
    ...
    A1Sentence(
      ...
      persian: 'کجا کار می‌کنی؟',
    ),
    A1Sentence(
      english: 'I work at a school.',
      persian: 'من در یک مدرسه کار می‌کنم.',
    ),
    A1Sentence(
    ...
    A1Sentence(
      ...
      persian: 'من موسیقی را دوست دارم.',
    ),
    A1Sentence(
      english: 'I learn English.',
      persian: 'من انگلیسی یاد می‌گیرم.',
    ),
    A1Sentence(
