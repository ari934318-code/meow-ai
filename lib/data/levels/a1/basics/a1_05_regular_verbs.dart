...
const A1BasicLesson a1BasicRegularVerbs = A1BasicLesson(
  ...
  learningPhases: [
    A1BasicLearningPhase(
      ...
      body: 'Look at these two sentences: I play football. He plays football. What changed? Do not worry about the answer yet. We will discover the rule step by step.',
      bodyFa: 'این دو جمله را ببین: I play football. و He plays football. چه چیزی تغییر کرده؟ فعلاً نگران جواب نباش. قرار است قانون را قدم‌به‌قدم کشف کنیم.',
      examples: [
        A1BasicExample(english: 'I play football.', persian: 'من فوتبال بازی می‌کنم.'),
    ...
    A1BasicLearningPhase(
      ...
      body: 'We use the present simple for habits, routines, repeated actions, and simple facts. The verb usually stays in its base form with I, you, we, and they.',
      bodyFa: 'از زمان حال ساده برای عادت‌ها، کارهای تکراری، برنامه‌های روزمره و بعضی واقعیت‌های ساده استفاده می‌کنیم. با I، you، we و they معمولاً از شکل پایه فعل استفاده می‌کنیم.',
      examples: [
        A1BasicExample(english: 'I work every day.', persian: 'من هر روز کار می‌کنم.'),
        A1BasicExample(english: 'They play football.', persian: 'آنها فوتبال بازی می‌کنند.'),
        A1BasicExample(english: 'She studies English.', persian: 'او انگلیسی می‌خواند.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'examples',
      ...
      body: 'First compare the same verb with different subjects. Notice that the verb changes with he, she, and it in positive sentences.',
      bodyFa: 'اول یک فعل یکسان را با فاعل‌های مختلف مقایسه کن. دقت کن که در جمله‌های مثبت، با he، she و it شکل فعل تغییر می‌کند.',
      examples: [
        A1BasicExample(english: 'I work here.', persian: 'من اینجا کار می‌کنم.'),
        A1BasicExample(english: 'You work here.', persian: 'تو اینجا کار می‌کنی.'),
        A1BasicExample(english: 'We work here.', persian: 'ما اینجا کار می‌کنیم.'),
        A1BasicExample(english: 'They work here.', persian: 'آنها اینجا کار می‌کنند.'),
        A1BasicExample(english: 'He works here.', persian: 'او اینجا کار می‌کند.'),
        A1BasicExample(english: 'She works here.', persian: 'او اینجا کار می‌کند.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'concept',
      ...
      titleFa: 'الگوی اصلی',
      body: 'In positive present simple sentences, I, you, we, and they use the base verb. He, she, and it usually use a changed verb form. This is the key pattern for this lesson.',
      bodyFa: 'در جمله مثبت حال ساده، I، you، we و they از شکل پایه فعل استفاده می‌کنند. He، she و it معمولاً شکل تغییرکرده فعل را می‌گیرند. این قانون اصلی این درس است.',
      examples: [
        A1BasicExample(english: 'I play.', persian: 'من بازی می‌کنم.'),
        A1BasicExample(english: 'They play.', persian: 'آنها بازی می‌کنند.'),
        A1BasicExample(english: 'He plays.', persian: 'او بازی می‌کند.'),
        A1BasicExample(english: 'She plays.', persian: 'او بازی می‌کند.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'chart',
      title: 'Who Uses the Base Form?',
      titleFa: 'چه کسی شکل پایه را استفاده می‌کند؟',
      body: 'Use the base form with I, you, we, and they. With he, she, and it, use the appropriate third-person singular form in positive sentences.',
      bodyFa: 'با I، you، we و they از شکل پایه استفاده کن. با he، she و it در جمله مثبت از شکل مناسب سوم‌شخص مفرد استفاده کن.',
      examples: [
        A1BasicExample(english: 'I work.', persian: 'من کار می‌کنم.'),
        A1BasicExample(english: 'You work.', persian: 'تو کار می‌کنی.'),
        A1BasicExample(english: 'We work.', persian: 'ما کار می‌کنیم.'),
        A1BasicExample(english: 'They work.', persian: 'آنها کار می‌کنند.'),
        A1BasicExample(english: 'He works.', persian: 'او کار می‌کند.'),
        A1BasicExample(english: 'She works.', persian: 'او کار می‌کند.'),
        A1BasicExample(english: 'It works.', persian: 'آن کار می‌کند.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 's',
      ...
      body: 'For many verbs, simply add s with he, she, and it: work → works, play → plays, read → reads.',
      bodyFa: 'برای بسیاری از فعل‌ها، با he، she و it فقط s اضافه می‌کنیم: work → works، play → plays، read → reads.',
      examples: [
        A1BasicExample(english: 'work → works', persian: 'کار کردن → کار می‌کند.'),
        A1BasicExample(english: 'play → plays', persian: 'بازی کردن → بازی می‌کند.'),
        A1BasicExample(english: 'read → reads', persian: 'خواندن → می‌خواند.'),
        A1BasicExample(english: 'eat → eats', persian: 'خوردن → می‌خورد.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'es',
      ...
      body: 'Some verbs ending in s, sh, ch, x, or o usually take es with he, she, and it: watch → watches, wash → washes, fix → fixes, go → goes.',
      bodyFa: 'بعضی فعل‌هایی که به s، sh، ch، x یا o ختم می‌شوند، با he، she و it معمولاً es می‌گیرند: watch → watches، wash → washes، fix → fixes، go → goes.',
      examples: [
        A1BasicExample(english: 'watch → watches', persian: 'تماشا کردن → تماشا می‌کند.'),
        A1BasicExample(english: 'wash → washes', persian: 'شستن → می‌شوید.'),
        A1BasicExample(english: 'fix → fixes', persian: 'تعمیر کردن → تعمیر می‌کند.'),
        A1BasicExample(english: 'go → goes', persian: 'رفتن → می‌رود.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'ies',
      title: 'Y → IES',
      titleFa: 'تبدیل Y به IES',
      body: 'When a verb ends in consonant + y, y usually changes to ies with he, she, and it. But after a vowel + y, we normally just add s.',
      bodyFa: 'اگر فعل به صامت + y ختم شود، y معمولاً با he، she و it به ies تبدیل می‌شود. اما اگر قبل از y یک حرف صدادار باشد، معمولاً فقط s اضافه می‌کنیم.',
      examples: [
        A1BasicExample(english: 'study → studies', persian: 'درس خواندن → درس می‌خواند.'),
        A1BasicExample(english: 'try → tries', persian: 'تلاش کردن → تلاش می‌کند.'),
        A1BasicExample(english: 'carry → carries', persian: 'حمل کردن → حمل می‌کند.'),
        A1BasicExample(english: 'play → plays', persian: 'بازی کردن → بازی می‌کند.'),
        A1BasicExample(english: 'enjoy → enjoys', persian: 'لذت بردن → لذت می‌برد.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'negative',
      ...
      body: 'Use don’t with I, you, we, and they. Use doesn’t with he, she, and it. After don’t or doesn’t, the main verb returns to the base form.',
      bodyFa: 'با I، you، we و they از don’t و با he، she و it از doesn’t استفاده می‌کنیم. بعد از don’t یا doesn’t، فعل اصلی به شکل پایه برمی‌گردد.',
      examples: [
        A1BasicExample(english: 'I don’t work here.', persian: 'من اینجا کار نمی‌کنم.'),
        A1BasicExample(english: 'They don’t play tennis.', persian: 'آنها تنیس بازی نمی‌کنند.'),
        A1BasicExample(english: 'She doesn’t work here.', persian: 'او اینجا کار نمی‌کند.'),
        A1BasicExample(english: 'He doesn’t play tennis.', persian: 'او تنیس بازی نمی‌کند.'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'questions',
      ...
      body: 'Use do with I, you, we, and they, and does with he, she, and it. The main verb stays in the base form after do or does.',
      bodyFa: 'با I، you، we و they از do و با he، she و it از does استفاده می‌کنیم. بعد از do یا does، فعل اصلی به شکل پایه می‌آید.',
      examples: [
        A1BasicExample(english: 'Do you work here?', persian: 'اینجا کار می‌کنی؟'),
        A1BasicExample(english: 'Do they play football?', persian: 'آنها فوتبال بازی می‌کنند؟'),
        A1BasicExample(english: 'Does she work here?', persian: 'او اینجا کار می‌کند؟'),
        A1BasicExample(english: 'Does he play football?', persian: 'او فوتبال بازی می‌کند؟'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'comparison',
      title: 'The Big Rule: Does + Base Verb',
      titleFa: 'قانون مهم: Does + شکل پایه فعل',
      body: 'In a positive sentence we say She works. When does or doesn’t appears, the main verb returns to work. Does carries the third-person marker.',
      bodyFa: 'در جمله مثبت می‌گوییم She works. وقتی does یا doesn’t می‌آید، فعل اصلی به شکل پایه یعنی work برمی‌گردد. در اینجا does علامت سوم‌شخص را با خودش حمل می‌کند.',
      examples: [
        A1BasicExample(english: 'She works here.', persian: 'او اینجا کار می‌کند.'),
        A1BasicExample(english: 'She doesn’t work here.', persian: 'او اینجا کار نمی‌کند.'),
        A1BasicExample(english: 'Does she work here?', persian: 'آیا او اینجا کار می‌کند؟'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'more_examples',
      ...
      body: 'Now compare positive, negative, and question forms with everyday verbs.',
      bodyFa: 'حالا شکل مثبت، منفی و سوالی را با فعل‌های روزمره مقایسه کن.',
      examples: [
        A1BasicExample(english: 'I study English.', persian: 'من انگلیسی می‌خوانم.'),
        A1BasicExample(english: 'She studies English.', persian: 'او انگلیسی می‌خواند.'),
        A1BasicExample(english: 'They don’t watch TV.', persian: 'آنها تلویزیون تماشا نمی‌کنند.'),
        A1BasicExample(english: 'Does he watch TV?', persian: 'آیا او تلویزیون تماشا می‌کند؟'),
        A1BasicExample(english: 'My sister likes music.', persian: 'خواهرم موسیقی دوست دارد.'),
      ],
    ),
    A1BasicLearningPhase(
      ...
      body: 'Complete the pattern. First use the base form, then notice the change with he, she, or it.',
      bodyFa: 'الگو را کامل کن. اول شکل پایه را به کار ببر، سپس تغییر آن را با he، she یا it ببین.',
      examples: [
        A1BasicExample(english: 'I work → She ___', persian: 'I work → She ___'),
        A1BasicExample(english: 'They play → He ___', persian: 'They play → He ___'),
        A1BasicExample(english: 'I study → She ___', persian: 'I study → She ___'),
        A1BasicExample(english: 'She works → She doesn’t ___', persian: 'She works → She doesn’t ___'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'independent',
      ...
      titleFa: 'تولید مستقل',
      body: 'Make your own sentences. Write one positive sentence with I, one with he or she, then turn one sentence into a negative and a question.',
      bodyFa: 'خودت جمله بساز. یک جمله مثبت با I و یک جمله با he یا she بنویس، سپس یکی از جمله‌ها را به منفی و سوالی تبدیل کن.',
      examples: [
        A1BasicExample(english: 'I play football.', persian: 'من فوتبال بازی می‌کنم.'),
        A1BasicExample(english: 'She plays football.', persian: 'او فوتبال بازی می‌کند.'),
        A1BasicExample(english: 'She doesn’t play football.', persian: 'او فوتبال بازی نمی‌کند.'),
        A1BasicExample(english: 'Does she play football?', persian: 'آیا او فوتبال بازی می‌کند؟'),
      ],
    ),
    A1BasicLearningPhase(
      type: 'real_world',
      ...
      body: 'Listen for these patterns in everyday English. Talk about routines: I work, I study, she works, he studies, they don’t work, does she study?',
      bodyFa: 'این الگوها را در انگلیسی روزمره دنبال کن. درباره کارهای روزمره صحبت کن: I work، I study، she works، he studies، they don’t work، does she study؟',
      examples: [
        A1BasicExample(english: 'I study English every day.', persian: 'من هر روز انگلیسی می‌خوانم.'),
        A1BasicExample(english: 'My brother works at home.', persian: 'برادرم در خانه کار می‌کند.'),
        A1BasicExample(english: 'We don’t watch TV at night.', persian: 'ما شب‌ها تلویزیون تماشا نمی‌کنیم.'),
      ],
    ),
  ],
