...
const A1BasicLesson a1BasicDoDoes = A1BasicLesson(
  ...
  questions: [
    ...
    A1BasicQuestion(
      ...
      explanation: 'You uses do and the base verb speak.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'Choose the correct sentence.',
    ...
    A1BasicQuestion(
      type: 'translation',
      question: 'ترجمه کن: «تو انگلیسی صحبت می‌کنی؟»',
      options: [
        'Do you speak English?',
        'Does you speak English?',
        'Do you speaks English?',
    ...
    A1BasicQuestion(
      type: 'translation',
      question: 'ترجمه کن: «او قهوه دوست دارد؟»',
      options: [
        'Does she like coffee?',
        'Do she like coffee?',
        'Does she likes coffee?',
      ...
      answer: 'Does she like coffee?',
      explanation: 'She uses does + base verb.',
    ),
    A1BasicQuestion(
      type: 'translation',
      question: 'ترجمه کن: «من نمی‌فهمم.»',
      options: [
        'I don’t understand.',
      ...
      explanation: 'I uses don’t + base verb.',
    ),
    A1BasicQuestion(
      type: 'translation',
      question: 'ترجمه کن: «او اینجا کار نمی‌کند.»',
      options: [
        'He doesn’t work here.',
        'He don’t work here.',
        'He doesn’t works here.',
      ...
      answer: 'He doesn’t work here.',
      explanation: 'He uses doesn’t + base verb.',
    ),
    A1BasicQuestion(
      type: 'word_order',
    ...
    A1BasicQuestion(
      ...
      explanation: 'We uses don’t + base verb.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'Which sentence is correct?',
    ...
    A1BasicQuestion(
      ...
      answer: 'Does it work?',
      explanation: 'It uses does + base verb.',
    ),
  ],
