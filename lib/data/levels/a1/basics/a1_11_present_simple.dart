...
const A1BasicLesson a1BasicPresentSimple = A1BasicLesson(
  ...
  explanation:
      'The Present Simple is used for habits, routines, repeated actions, facts, '
...
vocabulary: [
  ...
  A1BasicVocabulary(
    ...
    persian: 'رفتن',
    pronunciation: 'گو',
    example: 'He goes to work at nine.',
  ),
  A1BasicVocabulary(
    english: 'wake up',
    persian: 'بیدار شدن',
  ...
  A1BasicVocabulary(
    ...
    pronunciation: 'هَو بْرِکفَست',
    example: 'I have breakfast at eight.',
  ),
  A1BasicVocabulary(
    english: 'come home',
    persian: 'به خانه آمدن',
    pronunciation: 'کام هوم',
    example: 'He comes home at six.',
  ),
  A1BasicVocabulary(
  ...
  A1BasicVocabulary(
    english: 'always',
    persian: 'همیشه',
    pronunciation: 'آل‌وِیز',
    example: 'I always wake up early.',
  ),
  A1BasicVocabulary(
    english: 'usually',
    persian: 'معمولاً',
    pronunciation: 'یوژوِلی',
  ...
  A1BasicVocabulary(
    ...
    persian: 'اغلب',
    pronunciation: 'آفِن',
    example: 'We often watch movies.',
  ),
  A1BasicVocabulary(
    english: 'sometimes',
    persian: 'گاهی',
    pronunciation: 'سام‌تایمز',
    example: 'They sometimes eat out.',
  ),
  A1BasicVocabulary(
    english: 'never',
    persian: 'هرگز',
  ...
  A1BasicVocabulary(
    ...
    persian: 'قهوه',
    pronunciation: 'کافی',
    example: 'He always drinks coffee.',
  ),
  A1BasicVocabulary(
    english: 'tea',
    persian: 'چای',
  ...
  A1BasicVocabulary(
    ...
    persian: 'دیر',
    pronunciation: 'لِیت',
    example: 'I usually wake up late.',
  ),
  A1BasicVocabulary(
    english: 'home',
    persian: 'خانه',
  ...
  sections: [
    A1BasicSection(
      ...
      explanationFa:
          'از زمان حال ساده برای عادت‌ها، کارهای روزمره، اتفاق‌های تکراری، واقعیت‌ها و چیزهایی که معمولاً درست هستند استفاده می‌کنیم.',
      examples: [
        A1BasicExample(
        ...
        A1BasicExample(
          ...
          persian: 'او در یک بیمارستان کار می‌کند.',
        ),
        A1BasicExample(
          english: 'They live in Tokyo.',
          persian: 'آنها در توکیو زندگی می‌کنند.',
        ),
        A1BasicExample(
          english: 'Water boils at 100°C.',
          persian: 'آب در دمای ۱۰۰ درجه می‌جوشد.',
        ),
      ],
    ),
    ...
    A1BasicSection(
      ...
      explanationFa:
          'با I، you، we و they از شکل پایه فعل استفاده می‌کنیم و به فعل s یا es اضافه نمی‌کنیم؛ مثل I work و They play.',
      examples: [
        A1BasicExample(
        ...
        A1BasicExample(
          ...
          persian: 'تو انگلیسی می‌خوانی.',
        ),
        A1BasicExample(
          english: 'We live here.',
          persian: 'ما اینجا زندگی می‌کنیم.',
        ),
        A1BasicExample(
    ...
    A1BasicSection(
      ...
      explanationFa:
          'با he، she و it معمولاً شکل فعل تغییر می‌کند و s، es یا در بعضی فعل‌ها ies می‌گیرد؛ مثل works، watches و studies.',
      examples: [
        A1BasicExample(
        ...
        A1BasicExample(
          ...
          persian: 'آن خوب به نظر می‌رسد.',
        ),
        A1BasicExample(
          english: 'My brother plays games.',
          persian: 'برادرم بازی می‌کند.',
        ),
      ],
    ),
    ...
    A1BasicSection(
      ...
      explanationFa:
          'برای بسیاری از فعل‌ها، وقتی فاعل he، she یا it باشد، فقط s به انتهای فعل اضافه می‌کنیم؛ مثل work → works و play → plays.',
      examples: [
        A1BasicExample(
          english: 'work → works',
    ...
    A1BasicSection(
      ...
      explanationFa:
          'بعضی فعل‌ها با he، she و it به جای s، پسوند es می‌گیرند. این حالت در فعل‌هایی مانند watch، wash، fix و go دیده می‌شود.',
      examples: [
        A1BasicExample(
    ...
    A1BasicSection(
      ...
      explanationFa:
          'وقتی فعل به یک صامت + y ختم شود، در حالت he، she و it معمولاً y به ies تبدیل می‌شود؛ مثل study → studies و try → tries.',
      examples: [
        A1BasicExample(
        ...
        A1BasicExample(
          english: 'fly → flies',
          persian: 'پرواز کردن → پرواز می‌کند',
        ),
      ],
    ),
    ...
    A1BasicSection(
      ...
      explanationFa:
          'ساختار اصلی جمله مثبت در زمان حال ساده معمولاً فاعل + فعل + ادامه جمله است. فقط باید تفاوت شکل فعل با he، she و it را رعایت کنیم.',
      examples: [
        A1BasicExample(
    ...
    A1BasicSection(
      ...
      explanationFa:
          'برای منفی کردن جمله، با I، you، we و they از do not یا don’t و با he، she و it از does not یا doesn’t استفاده می‌کنیم. بعد از doesn’t فعل به شکل پایه برمی‌گردد.',
      examples: [
        A1BasicExample(
          english: 'I don’t work on Sunday.',
          persian: 'من یکشنبه کار نمی‌کنم.',
        ),
        A1BasicExample(
          english: 'They don’t like tea.',
          persian: 'آنها چای دوست ندارند.',
        ),
        A1BasicExample(
    ...
    A1BasicSection(
      ...
      explanationFa:
          'برای ساختن سؤال در زمان حال ساده، با I، you، we و they از Do و با he، she و it از Does استفاده می‌کنیم. فعل اصلی بعد از آن‌ها همیشه به شکل پایه می‌آید.',
      examples: [
        A1BasicExample(
    ...
    A1BasicSection(
      ...
      explanationFa:
          'در جواب کوتاه سؤال‌های حال ساده از do یا does استفاده می‌کنیم. مثلاً Do you like tea? با Yes, I do جواب داده می‌شود و Does she study? با Yes, she does.',
      examples: [
        A1BasicExample(
          english: 'Do you like tea? — Yes, I do.',
          persian: 'چای دوست داری؟ — بله.',
        ),
        A1BasicExample(
          english: 'Do they work here? — No, they don’t.',
          persian: 'آنها اینجا کار می‌کنند؟ — نه.',
        ),
        A1BasicExample(
          english: 'Does she study English? — Yes, she does.',
          persian: 'او انگلیسی می‌خواند؟ — بله.',
        ),
        A1BasicExample(
          english: 'Does he live here? — No, he doesn’t.',
          persian: 'او اینجا زندگی می‌کند؟ — نه.',
        ),
      ],
    ),
    ...
    A1BasicSection(
      ...
      explanationFa:
          'do گاهی فعل کمکی است و برای سؤال و منفی کردن استفاده می‌شود، اما گاهی خودش فعل اصلی به معنی انجام دادن است؛ مثل I do my homework.',
      examples: [
        A1BasicExample(
        ...
        A1BasicExample(
          ...
          persian: 'آیا تکالیفت را انجام می‌دهی؟',
        ),
        A1BasicExample(
          english: 'He doesn’t do his homework.',
          persian: 'او تکالیفش را انجام نمی‌دهد.',
        ),
      ],
    ),
    ...
    A1BasicSection(
      ...
      explanationFa:
          'قیدهای تکرار مانند always، usually، often، sometimes و never نشان می‌دهند یک کار با چه میزان تکراری انجام می‌شود و در صحبت درباره عادت‌ها بسیار کاربردی هستند.',
      examples: [
        A1BasicExample(
          english: 'I always wake up early.',
          persian: 'من همیشه زود بیدار می‌شوم.',
        ),
        A1BasicExample(
          english: 'She usually drinks coffee.',
          persian: 'او معمولاً قهوه می‌نوشد.',
        ),
        A1BasicExample(
          english: 'We often watch movies.',
          persian: 'ما اغلب فیلم تماشا می‌کنیم.',
        ),
        A1BasicExample(
          english: 'They sometimes eat out.',
          persian: 'آنها گاهی بیرون غذا می‌خورند.',
        ),
        A1BasicExample(
          english: 'He never smokes.',
          persian: 'او هرگز سیگار نمی‌کشد.',
        ),
      ],
    ),
    ...
    A1BasicSection(
      ...
      explanationFa:
          'زمان حال ساده برای صحبت درباره کارهای روزمره بسیار رایج است؛ مثل بیدار شدن، صبحانه خوردن، سر کار رفتن، به خانه آمدن و درس خواندن.',
      examples: [
        A1BasicExample(
        ...
        A1BasicExample(
          english: 'She goes to work at nine.',
          persian: 'او ساعت نه سر کار می‌رود.',
        ),
        A1BasicExample(
          english: 'He comes home at six.',
          persian: 'او ساعت شش به خانه می‌آید.',
        ),
        A1BasicExample(
          english: 'We study English at night.',
          persian: 'ما شب‌ها انگلیسی می‌خوانیم.',
        ),
      ],
    ),
    ...
    A1BasicSection(
      ...
      explanationFa:
          'اشتباه‌های رایج شامل فراموش کردن s با he، she و it و اضافه کردن دوباره s بعد از does یا doesn’t است. بعد از does و doesn’t همیشه شکل پایه فعل می‌آید.',
      examples: [
        A1BasicExample(
    ...
    A1BasicSection(
      ...
      explanationFa:
          'حال ساده در مکالمات واقعی دائماً برای صحبت درباره زندگی، عادت‌ها، کار، علایق و برنامه‌های روزمره استفاده می‌شود؛ مثل I live with my family و What time do you wake up?',
      examples: [
        A1BasicExample(
        ...
        A1BasicExample(
          english: 'I usually watch videos before bed.',
          persian: 'من معمولاً قبل از خواب ویدیو می‌بینم.',
        ),
        A1BasicExample(
          english: 'She works from home.',
          persian: 'او از خانه کار می‌کند.',
        ),
        A1BasicExample(
  ...
  examples: [
    ...
    A1BasicExample(
      ...
      persian: 'او اینجا زندگی می‌کند.',
    ),
    A1BasicExample(
      english: 'I don’t work on Friday.',
      persian: 'من جمعه کار نمی‌کنم.',
    ),
    A1BasicExample(
      english: 'He doesn’t work on Friday.',
      persian: 'او جمعه کار نمی‌کند.',
    ),
    A1BasicExample(
      english: 'Do you like English?',
      persian: 'انگلیسی را دوست داری؟',
    ),
    A1BasicExample(
      english: 'Does she like English?',
      persian: 'او انگلیسی را دوست دارد؟',
    ),
    A1BasicExample(
      english: 'I usually wake up late.',
      persian: 'من معمولاً دیر بیدار می‌شوم.',
    ),
    A1BasicExample(
      english: 'He always drinks coffee.',
      persian: 'او همیشه قهوه می‌نوشد.',
    ),
  ],
  ...
  questions: [
    ...
    A1BasicQuestion(
      ...
      options: ['studies', 'study', 'studys', 'studying'],
      answer: 'studies',
      explanation: 'With she, study changes to studies.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      ...
      answer: 'drinks',
      explanation: 'With he, add s to drink.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'They ___ in Tokyo.',
      options: ['live', 'lives', 'living', 'livies'],
      answer: 'live',
      explanation: 'With they, use the base form.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'She ___ in Tokyo.',
      options: ['lives', 'live', 'living', 'livies'],
      answer: 'lives',
      explanation: 'With she, use lives.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      ...
      answer: 'watch',
      explanation: 'With we, use the base form.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'He ___ movies on weekends.',
      options: ['watches', 'watch', 'watching', 'watchs'],
      answer: 'watches',
    ...
    A1BasicQuestion(
      ...
      options: ['like', 'likes', 'liking', 'likees'],
      answer: 'like',
    ...
    A1BasicQuestion(
      ...
      options: ['likes', 'like', 'liking', 'likees'],
      answer: 'likes',
      explanation: 'With she, use likes.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'He ___ to work at nine.',
      options: ['goes', 'go', 'gos', 'going'],
      answer: 'goes',
      explanation: 'Go takes es with he.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'They ___ to work at nine.',
    ...
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'She ___ TV every night.',
    ...
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'He ___ work on Sunday.',
    ...
    A1BasicQuestion(
      ...
      options: ['doesn’t', 'don’t', 'not', 'isn’t'],
      answer: 'doesn’t',
      explanation: 'Use doesn’t with she.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
    ...
    A1BasicQuestion(
      ...
      explanation: 'Use doesn’t + base verb.',
    ),
    A1BasicQuestion(
      type: 'multiple_choice',
      question: 'Which sentence is correct?',
    ...
    A1BasicQuestion(
      type: 'true_false',
      question: 'We use the Present Simple for regular habits.',
      options: ['True', 'False'],
      answer: 'True',
      explanation: 'Habits are a common use of the Present Simple.',
    ),
    A1BasicQuestion(
      type: 'true_false',
      question: 'He works is correct.',
      options: ['True', 'False'],
      answer: 'True',
      explanation: 'He takes works.',
    ),
    A1BasicQuestion(
      type: 'true_false',
      question: 'He work is correct in the Present Simple.',
      options: ['True', 'False'],
      answer: 'False',
      explanation: 'With he, use works.',
    ),
    A1BasicQuestion(
      type: 'true_false',
      question: 'Does she likes coffee? is correct.',
      options: ['True', 'False'],
      answer: 'False',
    ...
    A1BasicQuestion(
      type: 'true_false',
      question: 'She doesn’t works here is correct.',
      options: ['True', 'False'],
      answer: 'False',
      explanation: 'After doesn’t, use work, not works.',
    ),
    A1BasicQuestion(
      type: 'translation',
    ...
    A1BasicQuestion(
      ...
      explanation: 'Use Do with you and the base verb speak.',
    ),
    A1BasicQuestion(
      type: 'translation',
      ...
      explanation: 'Use Does with he and the base verb work.',
    ),
    A1BasicQuestion(
      type: 'word_order',
      question: 'Put the words in order: "English / study / I / every day"',
      options: [
        'I study English every day.',
        'English I every day study.',
        'Every day English study I.',
        'Study I every day English.',
      ],
      answer: 'I study English every day.',
      explanation: 'Use subject + verb + object + time.',
    ),
    A1BasicQuestion(
      type: 'word_order',
      question: 'Put the words in order: "coffee / she / likes"',
      options: [
        'She likes coffee.',
        'Coffee she likes.',
        'Likes she coffee.',
      ...
      explanation: 'She takes likes.',
    ),
    A1BasicQuestion(
      type: 'word_order',
      question: 'Put the words in order: "you / do / English / speak"',
      options: [
        'Do you speak English?',
        'You do speak English?',
        'Do speak you English?',
        'Speak do you English?',
      ],
      answer: 'Do you speak English?',
      explanation: 'Questions use Do + subject + base verb.',
    ),
    A1BasicQuestion(
      type: 'word_order',
      ...
      explanation: 'Questions with she use Does + she + base verb.',
    ),
  ],
  ...
  speakingQuestions: [
    ...
    A1BasicSpeakingQuestion(
      question: 'Say: She studies English every day.',
      persian: 'بگو: او هر روز انگلیسی می‌خواند.',
      acceptableAnswers: [
        'she studies english every day',
      ],
    ),
    A1BasicSpeakingQuestion(
      question: 'Say: He likes coffee.',
      persian: 'بگو: او قهوه دوست دارد.',
      acceptableAnswers: [
        'he likes coffee',
      ],
    ),
    A1BasicSpeakingQuestion(
      question: 'Say: They live here.',
      persian: 'بگو: آنها اینجا زندگی می‌کنند.',
      acceptableAnswers: [
        'they live here',
      ],
    ),
    A1BasicSpeakingQuestion(
      question: 'Say: She doesn’t like tea.',
    ...
    A1BasicSpeakingQuestion(
      ...
      persian: 'بپرس: آیا انگلیسی صحبت می‌کنی؟',
      acceptableAnswers: [
        'do you speak english',
      ],
    ),
    ...
    A1BasicSpeakingQuestion(
      question: 'Say: I usually wake up late.',
      persian: 'بگو: من معمولاً دیر بیدار می‌شوم.',
      acceptableAnswers: [
        'i usually wake up late',
      ],
    ),
    A1BasicSpeakingQuestion(
      question: 'Say: He always drinks coffee.',
      persian: 'بگو: او همیشه قهوه می‌نوشد.',
      acceptableAnswers: [
        'he always drinks coffee',
      ],
    ),
    A1BasicSpeakingQuestion(
      question: 'Say: We study English at night.',
      persian: 'بگو: ما شب‌ها انگلیسی می‌خوانیم.',
      acceptableAnswers: [
