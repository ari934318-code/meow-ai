...
class MeowLocalizations {
  ...
  String get appLanguage => isPersian ? 'زبان برنامه' : 'App Language';
  ...
  String get personality => isPersian ? 'شخصیت میو' : 'Meow Personality';
  ...
  String get dailyGoal => isPersian ? 'هدف روزانه' : 'Daily Goal';
  ...
  String get dailyLearningReminders =>
      isPersian ? 'یادآوری روزانه یادگیری' : 'Daily learning reminders';
  ...
  String get voiceData => isPersian ? 'داده‌های صوتی' : 'Voice Data';

  String get appearance => isPersian ? 'ظاهر' : 'Appearance';

  String get theme => isPersian ? 'تم' : 'Theme';

  String get system => isPersian ? 'سیستم' : 'System';

  String get light => isPersian ? 'روشن' : 'Light';

  String get dark => isPersian ? 'تیره' : 'Dark';

  String get about => isPersian ? 'درباره' : 'About';

  String get aboutMeowAI => isPersian ? 'درباره Meow AI' : 'About Meow AI';

  String get englishLearningWithMeow =>
      isPersian ? 'یادگیری انگلیسی با میو' : 'English learning with Meow';

  String get englishLevel =>
      isPersian ? 'سطح زبان انگلیسی' : 'English Level';

  String get beginner => isPersian ? 'مبتدی' : 'Beginner';

  String get defaultVoice => isPersian ? 'پیش‌فرض' : 'Default';
}