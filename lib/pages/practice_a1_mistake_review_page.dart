...
class PracticeA1MistakeReviewPage extends StatefulWidget {
  const PracticeA1MistakeReviewPage({
    super.key,
  });

  @override
  State<PracticeA1MistakeReviewPage> createState() =>
      _PracticeA1MistakeReviewPageState();
}

class _PracticeA1MistakeReviewPageState
    extends State<PracticeA1MistakeReviewPage> {
  ...
  Future<void> _loadPractice() async {
    ...
    final shuffled =
        List<Map<String, dynamic>>.from(mistakes)
          ..shuffle(Random());
